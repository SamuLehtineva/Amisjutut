 ...
 */
public class gui2jframe2 extends javax.swing.JFrame {

    /**
     * Creates new form gui2jframe2
     */
    public gui2jframe2() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gui2jframe2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gui2jframe2().setVisible(true);
            }
        });
    }
