...
<div class="sidenav">
    ...
    <a href="admin_index.php?sivu=adminpage"><i class="fas fa-home"></i> Etusivu</a>
    ...
    <a href="admin_index.php?sivu=coordination"><i class="far fa-calendar-alt"></i> Koordinaatio</a>
    <a href="admin_index.php?sivu=user_list"><i class="far fa-user"></i> K채ytt채j채lista</a>
