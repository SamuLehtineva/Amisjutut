...
<?php
echo "<form action=\"mobtunninedit.php?month=$month&pvm=$pvm\" method=\"post\" id=\"tunti\">";
...
Klo
<bR>
<input readonly="readonly" type="text" class="timepicker" name="klo" value="<?php echo $klo; ?>" />
